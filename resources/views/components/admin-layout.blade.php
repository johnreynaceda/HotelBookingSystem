                    ...
                    <div class="flex flex-col flex-grow px-4 mt-5">
                        ...
                        <nav class="flex-1 space-y-1 bg-white">
                            ...
                            @if (auth()->user()->is_admin == true)
                                ...
                                <ul>
                                    <li>
                                        <a class="{{ request()->routeIs('admin.report') || request()->routeIs('user.report') ? 'bg-gray-100 text-main scale-95' : '' }} inline-flex items-center w-full px-4 py-2 mt-1 text-sm text-gray-500 transition duration-200 ease-in-out transform rounded-lg focus:shadow-outline hover:bg-gray-100 hover:scale-95 hover:text-main"
                                    ...
                                    <li>
                                        <a class="{{ request()->routeIs('admin.faq') ? 'bg-gray-100 text-main scale-95' : '' }} inline-flex items-center w-full px-4 py-2 mt-1 text-sm text-gray-500 transition duration-200 ease-in-out transform rounded-lg focus:shadow-outline hover:bg-gray-100 hover:scale-95 hover:text-main"
                                    ...
                                    <li>
                                        <a class="{{ request()->routeIs('admin.comment') ? 'bg-gray-100 text-main scale-95' : '' }} inline-flex items-center w-full px-4 py-2 mt-1 text-sm text-gray-500 transition duration-200 ease-in-out transform rounded-lg focus:shadow-outline hover:bg-gray-100 hover:scale-95 hover:text-main"

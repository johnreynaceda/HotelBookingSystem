...
<body class="font-sans antialiased relative">
    ...
    <div class=" relative ">
        ...
        <main class="2xl:mx-auto 2xl:max-w-7xl mx-5 2xl:my-10 my-5  relative">
            {{-- <header class="font-bold 2xl:text-5xl text-2xl uppercase text-main font-riot">FAQ</header>
            <div class="2xl:mt-10 mt-5">
                <ul>
                    @foreach (\App\Models\Faq::all() as $item)
                        <li>
                            <h1 class="font-bold text-lg text-main">{{ $item->question }}</h1>
            ...
            <section aria-labelledby="feature-five" id="feature-five" class=" bg-white ">
                <div class="px-8 py-24 mx-auto lg:px-16 max-w-7xl md:px-12 lg:flex">
                    <div class="lg:w-1/2">
                        <div class="top-0 pt-8 pb-16 lg:sticky">
                            <div>
                                <div class="lg:pr-24 md:pr-12">
                                    <div>
                                        <p class="text-5xl text-main font-riot">
                    ...
                    <div class=" lg:w-1/2">
                        <div class="flex-shrink-0">
                            <div class="p-4 mx-auto lg:max-w-7xl lg:p-0">
                                <ul role="list" class="grid grid-cols-2 gap-4 list-none lg:gap-12">
                                    @foreach (\App\Models\Faq::all() as $item)
                                        <li>
                                            <div>
                                            ...
                                            <p class="mt-2 text-base text-gray-500 whitespace-pre-line">
                                                {{ $item->answer }}
                                            </p>
                                        </li>
                                    @endforeach
